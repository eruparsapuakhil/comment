  ...
  <div class="login-container">
    <section class="login" id="login">
      ...
      <form class="login-form" action="db.php" method="post">
        <input type="text" class="login-input" placeholder="name" name="name1" required autofocus />
        <input type="email" class="login-input" name="mail" placeholder="enter your mail" required />
        <input type="text" class="login-input" placeholder="comment here" name="cmnt" required autofocus />
...
{ 
 ...
 if(($_GET['error']=='success')||($_GET['error']=='ok')){
$server='localhost';
$user='root';
$pass='';
$dbname='reviews';
...
elseif($_GET['error']=='comnted')
{
    echo '<p style="color:red">You have given your comment already using this email</p>';
    
    echo '<form action="form.php?error=ok" method="post">';
    echo '<button type="submit" class="see">Click here to view the comments</button>';
    echo '</form>';
}
